...
public class SchedulerSystem {
    ...
    public void enqueue(SchedulerBase sched) {
        if (isEnqueued(sched))
            throw new IllegalStateException("Task with id " + sched.getTaskId() + " is already scheduled.");
    ...
    public void dequeue(SchedulerBase sched) {
        if (!isEnqueued(sched))
            throw new IllegalStateException("Task with id " + sched.getTaskId() + " is not yet scheduled.");
